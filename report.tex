...
\VAtitle{PREDICTION AND FORECASTING OF AIR POLLUTION}
...
This report contains 7 chapters. Chapter 1 gives the introduction to the project work and
...
in chater 4. Implementation and deployment is in chapter 5. Result evaluation is in chapter 6 and atlast conclusion and future development in chapter 7 
...
\begin{tikzpicture}
\node at (0,0) {\includegraphics[width=12cm]{int1.jpg}};
\node at (0,-12) {\includegraphics[width=12cm]{int2.jpg}};
\end{tikzpicture}

\pagebreak
\begin{tikzpicture}
\node at (0,0) {\includegraphics[width=12cm]{int3.jpg}};
\node at (0,-12) {\includegraphics[width=12cm]{int4.jpg}};
\end{tikzpicture}
\chapter{CONCLUSION}
